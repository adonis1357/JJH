...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("         2. 경기장을 벗어나면 죽습니다.");
        ...
        Console.WriteLine("         7. 높은 점수를 획득할 수록 가까운 곳에서 몬스터가 리젠됩니다.");
